        ...
        <div className="max-w-[1200px] mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <a href="https://docs.dork.fi" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-ocean-teal hover:text-ocean-teal/80 transition-colors text-sm font-medium">
                Documentation <ExternalLink size={14} />
              </a>
              <div className="flex items-center gap-3">
                <a href="https://discord.gg/dorkfi" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-ocean-teal transition-colors" aria-label="Join Discord">
                ...
                <a href="https://twitter.com/dorkfi" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-ocean-teal transition-colors" aria-label="Follow on Twitter">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
